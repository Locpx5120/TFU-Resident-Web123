...
import TableCustom from "../../Table";
  ...
  const columnData = [
      ...
      { name: "Ten du an", align: "left", esName: "tenDuAn", sortable: true },
      { name: "Phi thu", align: "left", esName: "phiThu" },
      { name: "Trang thai", align: "left", esName: "trangThai" },
    ];
    
    const fakeRows = [
    ];
  
  export default ReportInvestor;
